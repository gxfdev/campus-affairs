...
CREATE TABLE IF NOT EXISTS `course_schedule` (
  ...
  `course_type` varchar(20) DEFAULT '必修' COMMENT '课程类型：必修/选修/实践',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` tinyint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
-- 迁移：为已有表添加新字段（如果不存在）
ALTER TABLE `course_schedule` ADD COLUMN IF NOT EXISTS `credit` decimal(3,1) DEFAULT '2.0' COMMENT '学分';
ALTER TABLE `course_schedule` ADD COLUMN IF NOT EXISTS `course_type` varchar(20) DEFAULT '必修' COMMENT '课程类型：必修/选修/实践';

-- 更新已有课程的学分和类型
UPDATE `course_schedule` SET `credit` = 5.0, `course_type` = '必修' WHERE `course_name` LIKE '%高等数学%';
UPDATE `course_schedule` SET `credit` = 4.0, `course_type` = '必修' WHERE `course_name` LIKE '%线性代数%';
UPDATE `course_schedule` SET `credit` = 4.0, `course_type` = '必修' WHERE `course_name` LIKE '%概率论%';
UPDATE `course_schedule` SET `credit` = 4.0, `course_type` = '必修' WHERE `course_name` LIKE '%C语言%' OR `course_name` LIKE '%C++%';
UPDATE `course_schedule` SET `credit` = 4.0, `course_type` = '必修' WHERE `course_name` LIKE '%Java%' OR `course_name` LIKE '%面向对象%';
UPDATE `course_schedule` SET `credit` = 3.5, `course_type` = '必修' WHERE `course_name` LIKE '%数据结构%';
UPDATE `course_schedule` SET `credit` = 3.5, `course_type` = '必修' WHERE `course_name` LIKE '%算法%';
UPDATE `course_schedule` SET `credit` = 3.5, `course_type` = '必修' WHERE `course_name` LIKE '%操作系统%';
UPDATE `course_schedule` SET `credit` = 3.5, `course_type` = '必修' WHERE `course_name` LIKE '%数据库%';
UPDATE `course_schedule` SET `credit` = 3.5, `course_type` = '必修' WHERE `course_name` LIKE '%计算机网络%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '必修' WHERE `course_name` LIKE '%计算机组成%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '必修' WHERE `course_name` LIKE '%编译原理%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '必修' WHERE `course_name` LIKE '%计算机体系%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '必修' WHERE `course_name` LIKE '%信息安全%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '必修' WHERE `course_name` LIKE '%软件工程%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '必修' WHERE `course_name` LIKE '%离散数学%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '必修' WHERE `course_name` LIKE '%数字逻辑%';
UPDATE `course_schedule` SET `credit` = 2.0, `course_type` = '必修' WHERE `course_name` LIKE '%大学英语%';
UPDATE `course_schedule` SET `credit` = 2.0, `course_type` = '必修' WHERE `course_name` LIKE '%体育%';
UPDATE `course_schedule` SET `credit` = 2.0, `course_type` = '必修' WHERE `course_name` LIKE '%思想道德%' OR `course_name` LIKE '%马克思主义%' OR `course_name` LIKE '%中国近现代%' OR `course_name` LIKE '%毛泽东%';
UPDATE `course_schedule` SET `credit` = 2.0, `course_type` = '必修' WHERE `course_name` LIKE '%计算机导论%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '选修' WHERE `course_name` LIKE '%人工智能%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '选修' WHERE `course_name` LIKE '%机器学习%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '选修' WHERE `course_name` LIKE '%深度学习%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '选修' WHERE `course_name` LIKE '%自然语言%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '选修' WHERE `course_name` LIKE '%计算机视觉%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '选修' WHERE `course_name` LIKE '%云计算%';
UPDATE `course_schedule` SET `credit` = 3.0, `course_type` = '选修' WHERE `course_name` LIKE '%大数据%';
UPDATE `course_schedule` SET `credit` = 2.0, `course_type` = '实践' WHERE `course_name` LIKE '%课程设计%';
UPDATE `course_schedule` SET `credit` = 2.0, `course_type` = '综合实验' WHERE `course_name` LIKE '%综合实验%';
...
-- ===== 2025-2026学年第一学期 新增课程（含综合实验） =====
INSERT INTO `course_schedule` (`class_name`, `course_name`, `teacher_name`, `location`, `day_of_week`, `period_start`, `period_end`, `semester`, `credit`, `course_type`) VALUES
-- 计科2401 大二上学期 (2025-2026-1)
('计科2401','数据结构','赵志强','教学楼A201',1,1,2,'2025-2026-1',3.5,'必修'),
('计科2401','计算机组成原理','周明','教学楼A203',1,3,4,'2025-2026-1',3.0,'必修'),
('计科2401','面向对象程序设计(Java)','李明','实验楼B201',2,1,2,'2025-2026-1',4.0,'必修'),
('计科2401','数据结构','赵志强','教学楼A201',2,3,4,'2025-2026-1',3.5,'必修'),
('计科2401','马克思主义基本原理','刘芳','教学楼A102',3,1,2,'2025-2026-1',2.0,'必修'),
('计科2401','面向对象程序设计(Java)','李明','实验楼B201',3,3,4,'2025-2026-1',4.0,'必修'),
('计科2401','大学英语(三)','张丽华','外语楼C302',4,1,2,'2025-2026-1',2.0,'必修'),
('计科2401','综合实验','吴强','实验楼B301',4,3,4,'2025-2026-1',2.0,'综合实验'),
('计科2401','体育(三)','孙强','体育馆',5,1,2,'2025-2026-1',2.0,'必修'),
('计科2401','综合实验','吴强','实验楼B301',5,3,4,'2025-2026-1',2.0,'综合实验'),

-- 计科2301 大三上学期 (2025-2026-1)
('计科2301','操作系统','周明','教学楼A201',1,1,2,'2025-2026-1',3.5,'必修'),
('计科2301','计算机网络','赵志强','教学楼A303',1,3,4,'2025-2026-1',3.5,'必修'),
('计科2301','数据库原理','吴强','实验楼B301',2,1,2,'2025-2026-1',3.5,'必修'),
('计科2301','软件工程','钱伟','教学楼A305',2,3,4,'2025-2026-1',3.0,'必修'),
('计科2301','操作系统','周明','教学楼A201',3,1,2,'2025-2026-1',3.5,'必修'),
('计科2301','综合实验','吴强','实验楼B301',3,3,4,'2025-2026-1',2.0,'综合实验'),
('计科2301','数据库原理','吴强','实验楼B301',4,1,2,'2025-2026-1',3.5,'必修'),
('计科2301','人工智能导论','孙强','教学楼A401',4,3,4,'2025-2026-1',3.0,'选修'),
('计科2301','综合实验','钱伟','实验楼B302',5,1,2,'2025-2026-1',2.0,'综合实验'),
('计科2301','软件工程','钱伟','教学楼A305',5,3,4,'2025-2026-1',3.0,'必修'),

-- 计科2201 大四上学期 (2025-2026-1)
('计科2201','编译原理','陈伟','教学楼A401',1,1,2,'2025-2026-1',3.0,'必修'),
('计科2201','计算机体系结构','周明','教学楼A403',1,3,4,'2025-2026-1',3.0,'必修'),
('计科2201','信息安全','赵志强','教学楼A405',2,1,2,'2025-2026-1',3.0,'必修'),
('计科2201','编译原理','陈伟','教学楼A401',2,3,4,'2025-2026-1',3.0,'必修'),
('计科2201','机器学习','孙强','实验楼B401',3,1,2,'2025-2026-1',3.0,'选修'),
('计科2201','综合实验','吴强','实验楼B402',3,3,4,'2025-2026-1',2.0,'综合实验'),
('计科2201','计算机视觉','钱伟','教学楼A407',4,1,2,'2025-2026-1',3.0,'选修'),
('计科2201','综合实验','钱伟','实验楼B402',5,1,2,'2025-2026-1',2.0,'综合实验'),

-- 网工2401 大二上学期 (2025-2026-1)
('网工2401','数据结构','赵志强','教学楼B201',1,1,2,'2025-2026-1',3.5,'必修'),
('网工2401','计算机组成原理','周明','教学楼B203',1,3,4,'2025-2026-1',3.0,'必修'),
('网工2401','面向对象程序设计(Java)','李明','实验楼C201',2,1,2,'2025-2026-1',4.0,'必修'),
('网工2401','数据结构','赵志强','教学楼B201',2,3,4,'2025-2026-1',3.5,'必修'),
('网工2401','马克思主义基本原理','刘芳','教学楼B102',3,1,2,'2025-2026-1',2.0,'必修'),
('网工2401','综合实验','吴强','实验楼C301',3,3,4,'2025-2026-1',2.0,'综合实验'),
('网工2401','大学英语(三)','张丽华','外语楼C302',4,1,2,'2025-2026-1',2.0,'必修'),
('网工2401','体育(三)','孙强','体育馆',5,1,2,'2025-2026-1',2.0,'必修'),

-- 数据2401 大二上学期 (2025-2026-1)
('数据2401','数据结构','赵志强','教学楼C201',1,1,2,'2025-2026-1',3.5,'必修'),
('数据2401','计算机组成原理','周明','教学楼C203',1,3,4,'2025-2026-1',3.0,'必修'),
('数据2401','面向对象程序设计(Java)','李明','实验楼D201',2,1,2,'2025-2026-1',4.0,'必修'),
('数据2401','大数据导论','孙强','教学楼C205',2,3,4,'2025-2026-1',3.0,'选修'),
('数据2401','马克思主义基本原理','刘芳','教学楼C102',3,1,2,'2025-2026-1',2.0,'必修'),
('数据2401','综合实验','吴强','实验楼D301',3,3,4,'2025-2026-1',2.0,'综合实验'),
('数据2401','大学英语(三)','张丽华','外语楼C303',4,1,2,'2025-2026-1',2.0,'必修'),
('数据2401','体育(三)','孙强','体育馆',5,1,2,'2025-2026-1',2.0,'必修'),

-- 物联2401 大二上学期 (2025-2026-1)
('物联2401','数据结构','赵志强','教学楼D201',1,1,2,'2025-2026-1',3.5,'必修'),
('物联2401','计算机组成原理','周明','教学楼D203',1,3,4,'2025-2026-1',3.0,'必修'),
('物联2401','面向对象程序设计(Java)','李明','实验楼E201',2,1,2,'2025-2026-1',4.0,'必修'),
('物联2401','物联网导论','孙强','教学楼D205',2,3,4,'2025-2026-1',3.0,'选修'),
('物联2401','马克思主义基本原理','刘芳','教学楼D102',3,1,2,'2025-2026-1',2.0,'必修'),
('物联2401','综合实验','吴强','实验楼E301',3,3,4,'2025-2026-1',2.0,'综合实验'),
('物联2401','大学英语(三)','张丽华','外语楼C304',4,1,2,'2025-2026-1',2.0,'必修'),
('物联2401','体育(三)','孙强','体育馆',5,1,2,'2025-2026-1',2.0,'必修');

-- ===== 2025-2026学年第二学期 =====
INSERT INTO `course_schedule` (`class_name`, `course_name`, `teacher_name`, `location`, `day_of_week`, `period_start`, `period_end`, `semester`, `credit`, `course_type`) VALUES
-- 计科2401 大二下学期 (2025-2026-2)
('计科2401','算法设计与分析','赵志强','教学楼A201',1,1,2,'2025-2026-2',3.5,'必修'),
('计科2401','操作系统','周明','教学楼A203',1,3,4,'2025-2026-2',3.5,'必修'),
('计科2401','计算机网络','赵志强','教学楼A303',2,1,2,'2025-2026-2',3.5,'必修'),
('计科2401','算法设计与分析','赵志强','教学楼A201',2,3,4,'2025-2026-2',3.5,'必修'),
('计科2401','毛泽东思想概论','刘芳','教学楼A102',3,1,2,'2025-2026-2',2.0,'必修'),
('计科2401','操作系统','周明','教学楼A203',3,3,4,'2025-2026-2',3.5,'必修'),
('计科2401','数据库原理','吴强','实验楼B301',4,1,2,'2025-2026-2',3.5,'必修'),
('计科2401','综合实验','吴强','实验楼B301',4,3,4,'2025-2026-2',2.0,'综合实验'),
('计科2401','体育(四)','孙强','体育馆',5,1,2,'2025-2026-2',2.0,'必修'),
('计科2401','综合实验','钱伟','实验楼B302',5,3,4,'2025-2026-2',2.0,'综合实验'),

-- 计科2301 大三下学期 (2025-2026-2)
('计科2301','编译原理','陈伟','教学楼A401',1,1,2,'2025-2026-2',3.0,'必修'),
('计科2301','软件工程','钱伟','教学楼A305',1,3,4,'2025-2026-2',3.0,'必修'),
('计科2301','深度学习','孙强','实验楼B401',2,1,2,'2025-2026-2',3.0,'选修'),
('计科2301','编译原理','陈伟','教学楼A401',2,3,4,'2025-2026-2',3.0,'必修'),
('计科2301','云计算','钱伟','教学楼A403',3,1,2,'2025-2026-2',3.0,'选修'),
('计科2301','综合实验','吴强','实验楼B401',3,3,4,'2025-2026-2',2.0,'综合实验'),
('计科2301','自然语言处理','赵志强','教学楼A405',4,1,2,'2025-2026-2',3.0,'选修'),
('计科2301','综合实验','钱伟','实验楼B402',5,1,2,'2025-2026-2',2.0,'综合实验'),

-- 计科2201 大四下学期 (2025-2026-2)
('计科2201','大数据技术','孙强','教学楼A501',1,1,2,'2025-2026-2',3.0,'选修'),
('计科2201','综合实验','吴强','实验楼B501',1,3,4,'2025-2026-2',2.0,'综合实验'),
('计科2201','毕业设计','陈伟','教学楼A503',2,1,2,'2025-2026-2',6.0,'实践'),
('计科2201','综合实验','钱伟','实验楼B502',3,1,2,'2025-2026-2',2.0,'综合实验');
